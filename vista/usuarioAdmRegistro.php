...
<head>
    ...
    <title>Juvenil - Registrar Administrador</title>
    <!-- plugins:css -->
...
<body>
    <div class="form-container">
        <h1 class="text-center w-100 bg-dark text-primary p-5 fw-bolder">REGISTRAR ADMINISTRADOR</h1>
        <div class="col-sm-8 col-mt-5 rounded-1">
            <form method="POST" class="shadow-lg p-5">
                ...
                <input type="submit" name="registraAdministrador" value="Registrar" class="btn btn-primary">
