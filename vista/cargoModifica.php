                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <div class="card">
                            ...
                            <label> Cargo</label>
                            <input type="text" name="cargo" value="<?php echo $reg['cargo']; ?>"class="form-control" style="color: aqua;">   
                            <input type="submit" name="Modificar" id="Modificar" value="Modificar" class="btn btn-success">
                            <a href="../controlador/cargoLista.php" class="btn btn-secondary">Cancelar</a>
                            </form>
                            <?php
                            }
                            ?>
