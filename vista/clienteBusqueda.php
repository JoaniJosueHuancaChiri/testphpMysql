                    ...
                    <div class="content-wrapper">
                        <div class="card">
                            ...
                            <form method="get">
                                ...
                                <input type="submit" value="Busca Cliente" name="Buscar" class="btn btn-primary"><br>
                                    ...
                                    <tbody>
                                        ...
                                        if (isset ($res)) {
                                            while ($r = mysqli_fetch_array($res)) {
                                                ...
                                                echo "<td><a href='clienteModifica.php?cod=" . $r[0] . "' class='btn btn-success'>Actualizar</a></td>";
                                                echo "<td><a href='clientelnactiva.php?cod=" . $r[0] . "' class='btn btn-danger'>Eliminar</a></td>";
                                                echo "</tr>";
                                            }
                                        }
                                        ?>
